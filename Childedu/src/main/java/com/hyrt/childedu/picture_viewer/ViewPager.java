...
public class ViewPager extends ViewGroup {
	...
	public interface OnPageChangeListener {
		 ...
		 * @see com.hyrt.childedu.picture_viewer.ViewPager#SCROLL_STATE_IDLE
		 * @see com.hyrt.childedu.picture_viewer.ViewPager#SCROLL_STATE_DRAGGING
		 * @see com.hyrt.childedu.picture_viewer.ViewPager#SCROLL_STATE_SETTLING
		 */
		public void onPageScrollStateChanged(int state);
	}

	/**
	 * Simple implementation of the {@link com.hyrt.childedu.picture_viewer.ViewPager.OnPageChangeListener} interface with
	 * stub implementations of each method. Extend this if you do not intend to
	 * override every method of {@link com.hyrt.childedu.picture_viewer.ViewPager.OnPageChangeListener}.
	 */
